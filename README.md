...
2. 02_programs contains the main replication file for the project, "SPI_literature_review_charts.qmd".  Execute this file to replicate the results.  It also contains another file in ./02_programs/misc_scripts/SDG_data_pull.Rmd.  This file is used to pull the data from the UN SDG database.  It is not necessary to run this file, as the data is already included in the repository.  However, it is included for transparency purposes.  If this file is executed, the replication code will no longer replicate, as the data will be overwritten.
