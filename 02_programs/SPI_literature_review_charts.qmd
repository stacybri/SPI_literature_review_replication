...
devindex <- c( 'HD.HCI.OVRL', 'hdi_value', 'env_perform_index', 'eci_value', 'press_free_score', 'better_life_index')

devindex_names <- c( 'WB Human Capital Index', "UN Human Development Index", 'Environmental Performance Index','Economic Complexity Index','World Press Freedom Index', 'OECD Better Life Index')
